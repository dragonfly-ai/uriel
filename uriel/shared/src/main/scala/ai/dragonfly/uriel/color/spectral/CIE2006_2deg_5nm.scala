...
object CIE2006_2deg_5nm extends SampleSet {
  override val samples:NArray[Sample] = NArray[Sample]( 
    ...
    Sample(440f, VecF[3]( 0.3482554f, 0.05033657f, 1.917479f )),
    Sample(445f, VecF[3]( 0.3418483f, 0.05743393f, 1.918437f )),
    ...
    Sample(555f, VecF[3]( 0.5280233f, 0.9994608f, 0.002327186f )),
    ...
    Sample(590f, VecF[3]( 1.109767f, 0.8115868f, 8.494468E-05f )),
    Sample(595f, VecF[3]( 1.14362f, 0.7544785f, 5.460706E-05f )),
    Sample(600f, VecF[3]( 1.151033f, 0.6918553f, 3.549661E-05f )),
